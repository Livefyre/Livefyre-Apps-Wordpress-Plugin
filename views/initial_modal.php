    ...
    <div class='lfapps-env-select-row clearfix'>
        <div class='lfapps-env-box lfapps-community'>
            <label for="lfapps-community-env-radio">
                <h4><input type="radio" id="lfapps-community-env-radio" name="lfapps-env" value="community" <?php checked( get_option( 'livefyre_apps-package_type' ),'community' ); ?>> <?php esc_html_e('Community', 'lfapps'); ?></h4>
        ...
        <div class='lfapps-env-box lfapps-enterprise'>
            <label for="lfapps-enterprise-env-radio">
                <h4><input type="radio" id="lfapps-enterprise-env-radio" name="lfapps-env" value="enterprise" <?php checked( get_option( 'livefyre_apps-package_type' ), 'enterprise' ); ?>> <?php esc_html_e('Enterprise', 'lfapps'); ?></h4>
