<div id="lfapps-general-metabox-holder" class="metabox-holder clearfix">
    ...
    <div class="postbox-container postbox-large">
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
            <div id="referrers" class="postbox ">
                <div class="handlediv" title="Click to toggle"><br></div>
                <h3 class="hndle"><span><?php esc_html_e('LiveChat Status', 'lfapps-chat'); ?></span></h3>
                <div class="inside">
                    <div class='lfcomments-status-row clearfix'>
                        ...
                        <div class='lfcomments-status-box'>
                            ...
                            <?php if($count_posts_with_closed_comments > 0): ?>
                                ...
                                To be sure that the LiveChat widget is visible on these posts or pages, simply click on the "enable" button next to each.</p>
    ...
    <div class="postbox-container postbox-large">
        <div id="normal-sortables" class="meta-box-sortables ui-sortable">
            <div id="referrers" class="postbox ">
                <div class="handlediv" title="Click to toggle"><br></div>
                <h3 class="hndle"><span><?php esc_html_e('LiveChat Shortcode', 'lfapps-chat'); ?></span></h3>
                <div class='inside'>
